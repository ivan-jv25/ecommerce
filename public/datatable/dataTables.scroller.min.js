...
(function(e) {
    ...
    e.extend(g.prototype, {
        ...
        scrollToRow: function(a, b) {
            ...
            0 > m && (m = 0);
            (f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== m && (d = !0, f = this._domain("virtualToPhysical", a * this.s.heights.row), this.s.redrawTop < f && f < this.s.redrawBottom && (this.s.forceReposition = !0, b = !1));
            ...
            if (!this.s.skip && !this.s.ingnoreScroll && c !== this.s.lastScrollTop)
                if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
                    ...
                    if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
                        ...
                        }, this.s.dt.oFeatures.bServerSide ? (clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(d, this.s.serverWait)) : d(), this.dom.loader && !this.s.loaderVisible && (this.dom.loader.css("display", "block"), this.s.loaderVisible = !0))
